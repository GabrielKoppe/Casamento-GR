function TextDay() {
    return (
      <div className="adjust_text">
        ...
        <p dir="ltr">&nbsp;</p>
        <p dir="ltr">Acontecer&aacute; no s&aacute;bado, 27 de agosto de 2022, &agrave;s 14h, no Pagum Jardins. <em>Estrada do Pontal, 1395 - casa 1 - Recreio dos Bandeirantes, RJ.</em></p>
        <p dir="ltr">&nbsp;</p>
